...
import { FALLBACK_QUESTIONS_BASICS, FALLBACK_QUESTIONS_TECHNICAL } from "@/data/fallbackQuizzes";
...
const Games = () => {
  ...
  const generateAndStartQuiz = async (category: "basics" | "technical") => {
    setIsGeneratingQuiz(true);
    const topic = category === "basics" ? "Stock Market Basics" : "Technical Analysis";
    ...
    try {
      ...
      // Fallback Logic
      const fallbackQuestions = category === "basics" ? FALLBACK_QUESTIONS_BASICS : FALLBACK_QUESTIONS_TECHNICAL;
